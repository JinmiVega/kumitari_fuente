    	...
    	// dataValor = data;
         ...
         for(var m=0;m<listaRespuestas.length;m++){  
      	   var resp = listaRespuestas[m]; 
      	   	htmlResp = htmlResp+"<li style='border-style: none;margin-bottom:1px;' data-rsp="+resp.valAlterEncrypt+" id="+"rela-"+resp.valAlterEncrypt+" ><span id="+resp.valAlterEncrypt+" class='estiloparrafo'>"+resp.parrafo+"</span>" +
