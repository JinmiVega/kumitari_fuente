...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Básico Quechua</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Kumitsary" />
			...
			<div class="row row-bottom-padded-md">
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-8 to-animate icon-desing-style">
								<div class="row">
									<div class="col-md-12">
										<div id="panel_intro" class="panel panel-default">
										  <div class="panel-body">
											<div id="header_lengua_intro" class="page-header">
											  <h2><img src="${pageContext.request.contextPath}/assets/images/icono-panel/lengua-min.png" alt="" class="img-responsive"> Quechua </h2>
											</div>
											<div id="nav_intro">
												<ul>
													<li class="active-sub-nivel"><img src="${pageContext.request.contextPath}/assets/images/icono-panel/basico-1_min.png" alt="" class="img-responsive"></li>
													<li><img src="${pageContext.request.contextPath}/assets/images/icono-panel/basico-2_min.png" alt="" class="img-responsive"></li>
													<li><img src="${pageContext.request.contextPath}/assets/images/icono-panel/basico-3_min.png" alt="" class="img-responsive"></li>
												</ul>
											</div>
											<div class="unidad_intro_body">
												<div class="leccion_body">
													<h3 class="unidad_head_intro">
														UNIDAD 01
													</h3>
													<nav>
														<ul class="list_leccione_intro">
															<li>
																<a href="quechua/basico/b1/u1/l1/nombre-leccion" title="">
																	<span class="item_leccion leccion-active">
																		<b>Nombre de la leccion</b>
																	</span>
																</a>
															</li>
															<li>
																<span class="item_leccion">
																	<b>Nombre de la leccion</b>
																</span>
															</li>
															<li>
