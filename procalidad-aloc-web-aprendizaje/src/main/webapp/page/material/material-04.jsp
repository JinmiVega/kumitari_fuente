...
<!-- marial 04 -->
	...
	<div class="row row-bottom-padded-md">
		<div class="col-md-12 fondo-lectura to-animate fadeInUp animated">
			...
			<%-- <div class="row">
				<div class="col-md-10">
					<c:choose>
						<c:when test="${not empty material.nombreImagen}">
							<img src="${pageContext.request.contextPath}/material/${material.nombreImagen}" alt="${material.nombreImagen}" class="img-responsive">
						</c:when>
						<c:otherwise>
							<img src="${pageContext.request.contextPath}/assets/images/actividad/mi-pueblo.JPG" alt="" class="img-responsive">
						</c:otherwise>
					</c:choose>
				</div>
			</div> --%>
			
			<div class="row"  style="-webkit-border-image: inherit;border: 0px solid transparent;"><!-- <c:if test="${not empty material.nomImgTipoTramDoc}">fondo-img-material</c:if>" --> 
				<!-- <div id="marial3" class="col-md-12" > --> <!-- style="margin-bottom: 24px;margin-top: 0px;padding: 30px;bottom: 0;top: 15px;" -->
						...
						<div class="col-md-12">
							...
							<div class="text-format resetCSS contex">
