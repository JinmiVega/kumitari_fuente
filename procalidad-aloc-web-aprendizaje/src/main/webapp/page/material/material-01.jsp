						...
						<div class="col-md-10">
							...
							<c:choose>
								<c:when test="${not empty material.nombreImagen}">
									<img src="${pageContext.request.contextPath}/material/${material.nombreImagen}" alt="${material.nombreImagen}" class="img-responsive" style="border-radius: 20px;">
								</c:when>
								<c:otherwise>
									<%-- <img src="${pageContext.request.contextPath}/assets/images/actividad/mi-pueblo.JPG" alt="" class="img-responsive" style="border-radius: 20px;"> --%>
			...
			<div class="row">
				...
				<div class="col-md-10">
					<div class="form-group text-center">
						<a id="btnNextMaterial" class="btn btn-primary icon-arrow btn-lg" onclick="irHaciaEjercicios()" href="#">
