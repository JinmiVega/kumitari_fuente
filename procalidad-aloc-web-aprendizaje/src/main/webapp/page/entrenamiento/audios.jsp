...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Realizar entrenamiento Quechua audios</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Realizar entrenamiento Quechua audios" />
	...
	<jsp:include page="../../../../../../../layouts/head-nav-view.jsp"></jsp:include>
			...
			<div class="row row-bottom-padded-md">
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-4">
								<div class="row">
									<div class="col-md-6 col-md-offset-3">
									   ...
									   <div id="nav-lengua-left">
									   		<ul>
									   			<li>
													<span class="link-img grises">
														<a href="${pageContext.request.contextPath}/lengua/quechua">
															<img src="${pageContext.request.contextPath}/assets/images/nivel/link-quechua.png" alt="" class="img-responsive">
														</a>
													</span>
													<span class="link-img grises">
														<a href="pupiletras">
															<img src="${pageContext.request.contextPath}/assets/images/entrenamiento/pupiletras-min.jpg" alt="" class="img-responsive">
														</a>
													</span>
													<span class="link-img grises">
														<a href="crucigramas">
															<img src="${pageContext.request.contextPath}/assets/images/entrenamiento/crucigramas-min.jpg" alt="" class="img-responsive">
														</a>
													</span>
													<span class="link-img grises">
														<a href="alternativas">
															<img src="${pageContext.request.contextPath}/assets/images/entrenamiento/alternativas-min.jpg" alt="" class="img-responsive">
														</a>
													</span>
													<span class="link-img">
														<a href="audios">
															<img src="${pageContext.request.contextPath}/assets/images/entrenamiento/audios-min.jpg" alt="" class="img-responsive">
														</a>
													</span>
													<span class="link-img grises">
														<a href="textos">
															<img src="${pageContext.request.contextPath}/assets/images/entrenamiento/textos-min.jpg" alt="" class="img-responsive">
														</a>
													</span>
									   			</li>
									   		</ul>
							...
							<div class="col-md-6 col-md-offset-1 to-animate" id="item-entrenamiento">
								<div class="row">
									<div class="col-md-12">
										<div class="row">
											<div class="col-md-12">
												<a href="../realizar-entrenamiento" id="regreso-link" title="" class="btn btn-sm btn-link"><i class="fa fa-angle-left"></i> Salir</a>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
												<img src="${pageContext.request.contextPath}/assets/images/entrenamiento/pupiletras-det.jpg" alt="">
											</div>
										</div>
									</div>
								</div>
	...
	<div id="mascota-main-fix">
		<div id="select-mascota-fix">
			<span class="fa fa-angle-left"></span>
			<span id="circle-icon-mascota" class="fa">
				<ul>
					<li></li>
					<li></li>
					<li></li>
		...
		<div id="actual-mascota-fix">
			<img src="${pageContext.request.contextPath}/assets/images/mascota/mascota-04.png" alt="" class="img-responsive">
		</div>
	</div>

	<jsp:include page="../../../../../../../layouts/footer-view.jsp"></jsp:include>

	<jsp:include page="../../../../../../../layouts/tienda-modal-view.jsp"></jsp:include>
	<jsp:include page="../../../../../../../layouts/premio-modal-view.jsp"></jsp:include>
	<jsp:include page="../../../../../../../layouts/detalle-tienda-modal-view.jsp"></jsp:include>
