...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Entrenamiento lecciones</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Entrenamiento lecciones" />
					...
					<div class="col-md-12 to-animate">
							<div class="row">
								...
								<div class="col-md-7 mt-2">
									<div class="row">
										<div class="col-md-12">
											<div class="txt-mensaje dialog-msg" style="background-image: url('${pageContext.request.contextPath}/assets/images/dialogo-fondo.png');padding-top:15px;">¿Deseas realizar un entrenamiento antes de continuar con las lecciones?</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12 mt-2">
											<a href="realizar-entrenamiento" class="btn btn-default btn-border-radius">Si, deseo conocer.</a>
											<!-- <button class="btn btn-default btn-border-radius"></button> -->
											<a href="01" class="btn btn-default btn-border-radius">No, gracias</a>
