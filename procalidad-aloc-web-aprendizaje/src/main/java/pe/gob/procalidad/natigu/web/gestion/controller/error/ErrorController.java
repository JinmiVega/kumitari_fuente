package pe.gob.procalidad.natigu.web.gestion.controller.error;
...
public class ErrorController extends BaseController {
	...
	@RequestMapping(value = "/NavegadorNoSoportado", method = RequestMethod.GET)
	public ModelAndView goLogin() {
		LoginVo prmLogin = new LoginVo();
		return  new ModelAndView("error/navegador_no_soportado", "command",prmLogin);
	}
