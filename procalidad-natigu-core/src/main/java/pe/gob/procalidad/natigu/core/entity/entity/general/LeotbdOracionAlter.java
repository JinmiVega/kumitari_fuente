...
@NamedStoredProcedureQueries({
	...
	@NamedStoredProcedureQuery(name = "leotbdOracionAlter.listar_todo", procedureName = "gene.fun_leotbd_altxcomporaci_listarTodo", 
			resultClasses = LeotbdOracionAlter.class, 
			parameters = 
			{
...
public class LeotbdOracionAlter implements Serializable {
	...
	private String v_tituloOra;
	private Long n_codmatpej;
	private String v_oracion;
	...
	public String getV_tituloOra() {
		return v_tituloOra;
	}

	public void setV_tituloOra(String v_tituloOra) {
		this.v_tituloOra = v_tituloOra;
	}
	...
	public String getV_oracion() {
		return v_oracion;
	}

	public void setV_oracion(String v_oracion) {
		this.v_oracion = v_oracion;
	}

	@Override
	public String toString() {
		return "LeotbdOracionAlter [nCodaltern=" + nCodaltern
				+ ", nCodcomporacion=" + nCodcomporacion + ", vNumespacio="
				+ vNumespacio + ", vAlternativa=" + vAlternativa
				+ ", vRptaestado=" + vRptaestado + ", vFlgest=" + vFlgest
				+ ", nCodusureg=" + nCodusureg + ", dFecreg=" + dFecreg
				+ ", vHostreg=" + vHostreg + ", nCodusumod=" + nCodusumod
				+ ", dFecmod=" + dFecmod + ", vHostmod=" + vHostmod
				+ ", v_tituloTipo=" + v_tituloTipo + ", v_tituloOra="
				+ v_tituloOra + ", n_codmatpej=" + n_codmatpej + ", v_oracion="
				+ v_oracion + "]";
	}
