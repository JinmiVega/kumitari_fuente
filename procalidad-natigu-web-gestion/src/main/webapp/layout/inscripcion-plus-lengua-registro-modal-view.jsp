          ...
          <div class="row">
            <div class="form-group col-md-4 mb-2">
                                                   ...
                                                   <f:input type="hidden" path="inscripcionLenguaBean.codigo"  id="codigoinscrlen"/>
                                                    ...
                                                    <f:select id="lblLenguamodal" path="inscripcionLenguaBean.lenguainscr.codigo" onchange="cargarNivelesInsc()" class="form-control selectReset" name="lblLenguamodal" data-validation-required-message="Este campo es requerido" required="required" disabled="true">
            ...
            <div class="form-group col-md-3 mb-2">
                                                  ...
                                                  <f:select id="cmm_nivel" path="inscripcionLenguaBean.nivel.codigoRegistro" onchange="muestraCamposCupos();" class="form-control selectReset" name="lblLenguamodal" data-validation-required-message="Este campo es requerido" required="required" disabled="true">
                	 ...
                	 <div class="form-group col-md-4">
                                                  <label for="telefonoUsuario">N&uacute;mero de cupos<span class="required">*</span></label>
                                                   <div class="controls">
                                                    <f:input  id="numCupos2" type="hidden" path="inscripcionLenguaBean.numeroCuposInsc" onkeypress="return justNumbers(event);" name="numCupos2" class="form-control" /> 
                                                   <input  id="numCupos" type="text" class="form-control" onkeypress="return justNumbers(event);" name="numCupos" class="form-control" data-validation-required-message="Este campo es requerido"  pattern="[0-9]{1,}" required="required" maxlength="3" /> 
          											</div>	
           </div>
...
<!-- ///registro -->
        ...
        <div class="modal-footer">
          ...
          <button type="submit" id="guardarbtninscr-lengua-registro-modal-view"
			onclick="agregarmaslengua()" class="btn btn-primary">
			<i class="fa fa-floppy-o"></i> Agregar más
		</button>
        </div>
<%--        </form> --%>
    <!--   </div>
...
//console.log('entro modal inscripcion registro modal view');

/* if ($("#codigoinscrlen").val()>0) {
	  $("#guardarbtninscr-lengua-registro-modal-view").prop("disabled",true);
