            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"> Premios  
                  </li>
                </ol>
              </div>
            </div>
               ...
               <input type="hidden"  id="tdr"   value="premioBean.codigo">
                      ...
                      <div class="col-xs-12">
                          <div class="card">
                              <div class="card-header">
                                  <h4 class="card-title">Listado de premios </h4>
                                      ...
                                      <div class="form-body">
                                        <div class="row">
                                            <div class="form-group col-md-3 mb-2">
                                              <label for="projectinput6">Tipo de premio</label>
                                              <f:select id="lblTipo"  path="tipo.codigoRegistro" class="form-control select-del">
                                            ...
                                            <div class="form-group col-md-3 mb-2">
                                                <label for="projectinput1">Nombre de premio</label>
                                                <f:input type="text" path="nombre" class="form-control" maxlength="70"/>
                                            </div>
                                            <div class="form-group col-md-3 mb-2">
                                              <label for="region">Regi&oacute;n</label>
                                              <f:select id="lblregion"  path="region.codigoRegistro" class="form-control select-del">
                                                <f:option value="0" label="Todas"/>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12 text-right">
                                                <a href="${pageContext.request.contextPath}/premioController/nuevo" class="btn btn-primary" title=""> <i class="icon-plus"></i> Nuevo</a>
                                               
                                               	<a href="${pageContext.request.contextPath}/premioController/listado" class="btn btn-flat btn-secondary">
                                          ...
                                          <div class="col-xs-12">
                                            <table class="table table-striped table-hover table-bordered zero-configuration">
                                                <thead>
                                                    <tr>
                                                        <th width="15">N°</th>
                                                        <th><center>Nombre de premio</th>
                                                        <th><center>Descripci&oacute;n</th>
                                                        <th><center>Imagen</th>
                                                        <th><center>Puntos</th>
                                                        <th width="80"><center>Tipo</th>
                                                        <th width="80"><center>Regi&oacute;n</th>
                                                        <th width="70"><center>Situaci&oacute;n</th>
                                                        <th width="60"><center>Acciones</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                 <f:input type="hidden" path="codigo"  id="codigoPremio"/>
                                                <c:forEach var="premioBean" items="${lstPremioBean}" varStatus="theCount">
                                                    <tr>
                                                        <td><center>${theCount.count}</td>
                                                        <td>${premioBean.nombre}</td>
                                                        <td>${premioBean.descripcion}</td>

                                                        <td>
                                                          <c:choose>
                                                      <c:when test="${not empty premioBean.imagenNombre}">
                                                        <img class="media-object" src="${pageContext.request.contextPath}/premio/${premioBean.imagenNombre}" alt="${premioBean.imagenNombre}" style="width: 64px;height: 64px;" />
                                                      </c:when>
                                                      <c:otherwise>
                                                        <img class="media-object" src="${pageContext.request.contextPath}/assets/img/pr2.jpg" alt="Imagen por defecto" style="width: 64px;height: 64px;" />
                                                      </c:otherwise>
                                                     </c:choose>
                                                        </td>


                                                        <td><center>${premioBean.puntos}</td>
                                                        <td><center> ${premioBean.tipo.nombreCorto} </td>
                                                        <td><center> ${premioBean.region.nombreCorto}</td>
                                                        <td><center>${premioBean.situacion.nombreCorto} </td>
                                                        <td>
                                                        <!-- 
                                                         <a title="Modificar"   data-placement="top" data-toggle="tooltip" class="btn btn-outline-success btn-sm" href="modificar?codigo=${premioBean.codigo}"><i class="icon-pencil"></i></a>
                                                          -->
                                                          <a title="Modificar" 
                                                        	data-placement="top" data-toggle="tooltip" class="btn btn-outline-success btn-sm"
                                                        	onclick="javascript:modificarElementoGenerico('/premioController/modificar','${premioBean.codigo}')"
                                                        	><i class="icon-pencil"></i></a>
                                                         <button type="button" class="btn btn-outline-danger btn-sm"  data-toggle="tooltip" data-placement="top" title="Eliminar" data-original-title="Eliminar"  onclick="confirmar_accion('${premioBean.codigo}');" ><i class="icon-trash"></i>
                                                        </td>
