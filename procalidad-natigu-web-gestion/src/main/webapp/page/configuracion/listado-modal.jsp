<%@ page contentType="text/html; charset=UTF-8" %>
    ...
    <title>Listado de modales</title>
          ...
          <div class="content-header-left col-md-6 col-xs-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
               ...
               <input type="hidden"  id="tdr"   value="modalBean.codigo">
                      ...
                      <div class="col-xs-12">
                          <div class="card">
                              <div class="card-header">
                                  <h4 class="card-title">Listado de modales </h4>
                                      ...
                                      <div class="form-body">
                                        <div class="row">
                                            <%-- <div class="form-group col-md-3 mb-2">
                                              <label for="projectinput6">Tipo de Modal</label>
                                            ...
                                            <div class="form-group col-md-3 mb-2">
                                                <label for="projectinput1">Nombre de modal</label>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12 text-right">
                                                <a href="${pageContext.request.contextPath}/modalController/nuevo" class="btn btn-primary" title=""> <i class="icon-plus"></i> Nuevo</a>
                                          ...
                                          <div class="col-xs-12">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                <thead>
                                                    <tr>
															<th width="10">N°</th>	
                                                        <th width="70"><center>Nombre de modal</th>
                                                        <th width="70"><center> Imagen</th>
                                                        <th width="60"><center>Situaci&oacute;n</th>
                                                ...
                                                <c:forEach var="modalBean" items="${lstModalBean}" varStatus="theCount">
                                                    <tr>
                                                    	<td><center>${theCount.count}</td>
                                                        <td><center>${modalBean.nombre}</td>

                                                        <td><center>
                                                      <c:choose>
                                                      <c:when test="${not empty modalBean.imagenNombre}">
                                                        <img class="media-object" src="${pageContext.request.contextPath}/modal/${modalBean.imagenNombre}" alt="${modalBean.imagenNombre}" style="width: 175px;height: 75px;" />
                                                      </c:when>
                                                      <c:otherwise>
                                                        ...
                                                        <td><center>${modalBean.situacion.nombreCorto} </td>
                                                       <%-- <td> ${modalBean.tipo.nombreCorto} </td> --%>

                                                        <td><center>
                                                         <!-- 
                                                         <a title="Modificar"   data-placement="top" data-toggle="tooltip" class="btn btn-outline-success btn-sm" href="modificar?codigo=${modalBean.codigo}"><i class="icon-pencil"></i></a>
                                                         -->
                                                          <a title="Modificar" 
                                                         	data-placement="top" data-toggle="tooltip" class="btn btn-outline-success btn-sm"
                                                         	onclick="javascript:modificarElementoGenerico('/modalController/modificar','${modalBean.codigo}')"
                                                         	><i class="icon-pencil"></i></a>
                                                         <button type="button" class="btn btn-outline-danger btn-sm"  data-toggle="tooltip" data-placement="top" title="Eliminar" data-original-title="Eliminar"  onclick="confirmar_accion('${modalBean.codigo}');" ><i class="icon-trash"></i>
                                                        </td>
