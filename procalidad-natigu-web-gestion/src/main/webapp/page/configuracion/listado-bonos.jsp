                      ...
                      <div class="col-xs-12">
                          <div class="card">
                              <div class="card-header">
                                  <h4 class="card-title">Listado de bonos </h4>
                                     ...
                                     <f:form method="post" action="buscar" id = "formularioBusqueda">
                                      <div class="form-body">
                                        ...
                                        <div class="form-group col-md-3 mb-2">
                                                <label for="projectinput1">Nombre de bono</label>
                                                <f:input type="text" path="nombre" class="form-control" maxlength="70"/>
                                            </div>
                                            
                                            <div class="form-group col-md-3 mb-2">
                                              <label for="projectinput6">Tipo de bono</label>
                                              <f:select id="lblTipo"  path="situacion.codigoRegistro" class="form-control select-del">
                                            ...
                                            <div class="form-group col-md-3 mb-2">
                                              ...
                                              <f:select id="lblSituacion"  path="tipo.codigoRegistro" class="form-control select-del">
                                                <f:option value="0" label="Todos"/>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12 text-right">
                                                <a href="${pageContext.request.contextPath}/bonoController/nuevo" class="btn btn-primary" title=""> <i class="icon-plus"></i> Nuevo</a>
                                        ...
                                        <div class="row">
                                          <div class="col-xs-12">
                                            <table class="table table-striped table-hover table-bordered zero-configuration">
                                                ...
                                                <c:forEach var="bonoBean" items="${lstBonoBean}" varStatus="theCount">
                                                    <tr>
                                                        <td><center>${theCount.count}</td>
                                                        <td>${bonoBean.nombre}</td>
                                                        <td>${bonoBean.descripcion}</td> 
                                                        <td><center> ${bonoBean.tipo.nombreCorto} </td> 
                                                        <td><center>${bonoBean.situacion.nombreCorto} </td>
                                                        <td>
                                                         <a title="Modificar" 
                                                         	data-placement="top" data-toggle="tooltip" class="btn btn-outline-success btn-sm"
                                                         	onclick="javascript:modificarElementoGenerico('/bonoController/modificar','${bonoBean.codigo}')"
                                                         	><i class="icon-pencil"></i></a>
                                                        <!-- 
                                                         <a title="Modificar"   data-placement="top" data-toggle="tooltip" class="btn btn-outline-success btn-sm" href="modificar?codigo=${bonoBean.codigo}"><i class="icon-pencil"></i></a>
                                                        -->
                                                         <button type="button" class="btn btn-outline-danger btn-sm"  data-toggle="tooltip" data-placement="top" title="Eliminar" data-original-title="Eliminar"  onclick="confirmar_accion('${bonoBean.codigo}');" ><i class="icon-trash"></i>
                                                        </td>
