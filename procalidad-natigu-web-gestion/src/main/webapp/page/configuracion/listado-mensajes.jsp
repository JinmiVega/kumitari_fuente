            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"> Mensajes 
                  </li>
                </ol>
              </div>
            </div>
                                      ...
                                      <div class="form-body">
                                        <div class="row">
											...
											<input type="hidden" id="contextPath" value="${pageContext.request.contextPath}">
                                                ...
                                                <f:select id="codLenguaMensajes"  path="lenguaBean.codigo" class="form-control select-del"
                                               >
                                               <f:option value="0" selected="true" disabled="disabled" label="Seleccionar"/>
                                                ...
                                                <div class="form-group col-md-3 mb-2">
                                                <label for="situacionModal">Tipo de mensaje </label>

                                                <f:select id="codTipoMensajes"  path="tipoMensaje.codigoRegistro" class="form-control select-del"
                                                >
                                               <f:option value="0" selected="true" disabled="disabled" label="Seleccionar"/>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12 text-right">
                                                <a href="${pageContext.request.contextPath}/mensajesController/nuevo"
                                                ...
                                                <button class="btn btn-flat btn-secondary" id="buscarMensajes" type="submit">
                                                 <i class="ft-search"></i> Buscar</button>
                                            </div>
                                        </div>
                                        <div class="row">
                                          <div class="col-xs-12" id ="bodyListadoMensajes">
											...
											<tr>
												...
												<td>
													 <a title="Modificar" 
                                                       	...
                                                       	onclick="javascript:modificarElementoGenerico('/mensajesController/modificar','${mensaje.codigo}')"
...
<script>
  ...
  function confirmar_eliminar(codigo){
	 // debugger;
  	//console.log("entro a confirmar eliminar");
  ...
  $('#btnConfirmarGeneric').click(function() {
	  ...
	  eliminarMensaje(codigoEliminar);
	});
  ...
  function eliminarMensaje(codigo){
	  //debugger;
       // alert("eliminarMensaje " + codigo);
           var contextPath = $('#contextPath').val();
	        $.ajax({
	          url : contextPath+"/mensajesController/eliminar?codigo="+codigo,
	          type : 'GET',
         	 ...
         	 function refrescarTablaListadoMensajes() {
         		var contextPath = $('#contextPath').val();
       			$.ajax({
     	   			url : contextPath+"/mensajesController/listadoMensajes",
     	   			type : 'GET',

     	   			success : function(data) {
     	   				console.log("SUCCESS: ", data);
     	   				//alert('recargar');
     	   				$('#bodyListadoMensajes').html(data);
