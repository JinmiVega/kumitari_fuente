            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"> Combos  
                  </li>
                </ol>
              </div>
            </div>
               ...
               <input type="hidden"  id="tdr"   value="comboBean.codigo">
                      ...
                      <div class="col-xs-12">
                          <div class="card">
                              <div class="card-header">
                                  <h4 class="card-title">Listado de combos </h4>
                                      ...
                                      <div class="form-body">
                                        <div class="row">
                                            <div class="form-group col-md-3 mb-2">
                                                <label for="projectinput1">Nombre de combo</label>
                                                <f:input type="text" path="titulo" class="form-control" maxlength="50"/>
                                            </div>
                                            <div class="form-group col-md-3 mb-2">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12 text-right">
                                                <a href="${pageContext.request.contextPath}/comboController/nuevo" class="btn btn-primary" title=""> <i class="icon-plus"></i> Nuevo</a>
                                        ...
                                        <div class="row">
                                          <div class="col-xs-12">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <c:forEach var="comboBean" items="${lstCombosBean}" varStatus="theCount"> 
                                                    <tr>
                                                  		 <td><center>${theCount.count}</td>	
                                                        <td>${comboBean.titulo}</td>
                                                        <td>${comboBean.descripcion}</td>
                                                        <td>${comboBean.monto}</td>
                                                        <td>${comboBean.mascotaBean.nombre}</td>
                                                        <td>${comboBean.fondoBean.nombre}</td>
                                                        <td>${comboBean.monedas}</td>
                                                        <td>${comboBean.gemas}</td>
                                                        <td>${comboBean.situacion.nombreCorto} </td>
                                                        <td>
                                                        <!--  
                                                         <a title="Modificar"   data-placement="top" data-toggle="tooltip" class="btn btn-outline-success btn-sm" href="modificar?liCodComb=${comboBean.codigo}"><i class="icon-pencil"></i></a>
                                                         -->
                                                          <a title="Modificar" 
                                                         	data-placement="top" data-toggle="tooltip" class="btn btn-outline-success btn-sm"
                                                         	onclick="javascript:modificarElementoGenerico('/comboController/modificar','${comboBean.codigo}')"
                                                         	><i class="icon-pencil"></i></a>
                                                         <button type="button" class="btn btn-outline-danger btn-sm"  data-toggle="tooltip" data-placement="top" title="Eliminar" data-original-title="Eliminar"  onclick="confirmar_accion('${comboBean.codigo}');"><i class="icon-trash"></i></button>
                                                        </td>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/scripts.js" type="text/javascript"></script>
     <script type="text/javascript" charset="utf-8" >
       $( "#btnConfirmarGeneric" ).click(function() {
        location.href ="eliminar?liCodComb="+prmCodigo;
