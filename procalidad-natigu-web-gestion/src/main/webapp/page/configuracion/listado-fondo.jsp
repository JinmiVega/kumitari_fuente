                                      ...
                                      <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3 mb-2">
                                                ...
                                                <f:input type="text" path="nombre" class="form-control" maxlength="70" onpaste="return false;"/>
                                            </div>
                                            <div class="form-group col-md-3 mb-2">
                                        ...
                                        <div class="row">
                                          <div class="col-xs-12">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <c:forEach var="fondoBean" items="${lstFondoBean}" varStatus="theCount">
                                                    <tr>
                                                      ...
                                                      <c:when test="${not empty fondoBean.imagenNombre}">
                                                        <img class="media-object" src="${pageContext.request.contextPath}/fondo/${fondoBean.imagenNombre}" alt="${fondoBean.imagenNombre}" style="width: 175px;height: 75px;" />
<%--                                                         <img class="media-object" src="${pageContext.request.contextPath}/fondo/${fondoBean.imagenNombre}" alt="${fondoBean.imagenNombre}" style="width: 64px;height: 64px;" /> --%>
                                                      </c:when>
                                                      <c:otherwise>
                                                      ...
                                                      <c:when test="${not empty fondoBean.imagenNombreTienda}">
                                                        <img class="media-object" src="${pageContext.request.contextPath}/fondo/${fondoBean.imagenNombreTienda}" alt="${fondoBean.imagenNombreTienda}" style="width: 75px;height: 75px;" />
<%--                                                         <img class="media-object" src="${pageContext.request.contextPath}/fondo/${fondoBean.imagenNombre}" alt="${fondoBean.imagenNombre}" style="width: 64px;height: 64px;" /> --%>
                                                      </c:when>
                                                      <c:otherwise>
                                                        <img class="media-object" src="${pageContext.request.contextPath}/assets/img/usar_imagen.jpg" alt="Imagen por defecto" style="width: 75px;height: 75px;" />
                                                        ...
                                                        <td><center>${fondoBean.situacion.nombreCorto} </td>
                                                        ...
                                                        <!-- 
                                                         ...
                                                         -->
                                                          <a title="Modificar" 
                                                         	...
                                                         	onclick="javascript:modificarElementoGenerico('/fondoController/modificar','${fondoBean.codigo}')"
