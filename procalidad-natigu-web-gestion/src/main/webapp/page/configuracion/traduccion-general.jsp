...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>Traducci&oacute;n General</title>
            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="#">Traducci&oacute;n General </a>
                  </li>
                </ol>
              </div>
            </div>
                      ...
                      <div class="col-xs-12">
                          <div class="card">
                              <div class="card-header">
                                  <h4 class="card-title"> Traducci&oacute;n General </h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3 mb-2">
                                              ...
                                              <select id="projectinput6" name="interested" class="form-control">
                                                  ...
                                                  <option value="design">Quechua Collao</option>
                                                  <option value="design">Aimara</option>
                                                  <option value="design">Chanka</option>
                                                  <option value="design">Shawi</option>
                                              </select>
                                            </div>
                                            <div class="form-group col-md-9 text-right">
                                                <a href="#" class="btn btn-primary" title=""> <i class="icon-plus"></i> Guardar</a>
                                          ...
                                          <div class="col-xs-12">
                                            <table class="table table-striped table-hover table-bordered zero-configuration">
                                                <thead>
                                                    <tr>
                                                        <th>Frase / Palabra </th>
                                                        <th  width="400">Traducci&oacute;n</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Ejercicios </td>
                                                        <td>
                                                            <textarea class="form-control"  name="fname"   >     </textarea>
                                                    ...
                                                    <tr>
                                                        <td>Entre ellos: Para pintar de colores figuras geom&eacute;tricas: se colocan figuras geom&eacute;tricas y colores al costado para poder rellenarlas del color que se indica en la instrucci&oacute;n. Para mover im&aacute;genes de un lado a otro y colocarlo en el lugar correcto: se describe c&oacute;mo deberían las im&aacute;genes. Para llegar a un lugar: se coloca un croquis y de acuerdo a la descripci&oacute;n se llega a un determinado lugar.
                                                        </td>
                                                        <td>
                                                            <textarea class="form-control" name="fname"   >     </textarea>
                                                        </td>
