  ...
  <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Puntos Premios
                  </li>
                </ol>
              </div>
            </div>
                      ...
                      <div class="col-xs-12">
                          <div class="card">
                              <div class="card-header">
                                  <h4 class="card-title"> Puntos Premios</h4>
                                  ...
                                  <div class="card-block card-dashboard">
                                    <div class="col-md-12">
                                      <ul class="nav nav-tabs nav-top-border no-hover-bg"> <!--
                                        ...
                                        <li class="nav-item">
                                          <a class="nav-link" id="base-tab14" data-toggle="tab" aria-controls="tab14" href="#tab14" aria-expanded="false">Lecci&oacute;n</a>
                                        </li> -->
                                        <li class="nav-item">
                                            ...
                                            <table class="table table-striped table-bordered zero-configuration dataTable ">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="70" rowspan="2">CATEGORIA</th>
                                                        <th colspan="6" rowspan="3"> <center> MEDALLAS </center> </th>
                                                        <th  width="150" rowspan="2"> <center> MONEDAS </center> </th>
                                                        <th  width="150" rowspan="2"> <center> GEMAS </center> </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                <tr>
                                                      <th rowspan="2">1</th>
                                                      <th rowspan="2">LECCION</th>
                                                      <th colspan="2" >BASICA</th>
                                                      <th colspan="2">HONORIFICA</th>
                                                      <th colspan="2">PREMIUM</th>

                                                      <th rowspan="2"  >
                                                          <div class="  col-md-2">
                                                            <input  type="text" value="5" id="" class="form-control" name="fname">
                                                          </div>
                                                      </th>
                                                      <th rowspan="2" >
                                                          <div class="  col-md-2  ">
                                                    ...
                                                    <tr>
                                                      <th colspan="2"><div class="  col-md-2 mb-0">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <th rowspan="2"  >
                                                          <div class="  col-md-2  ">
                                                            <input type="text" value="7" id="" class="form-control" name="fname">
                                                          </div>
                                                        </th>
                                                        <th rowspan="2" >
                                                          <div class="  col-md-2  ">
                                                    ...
                                                    <tr>
                                                      <th colspan="2"><div class="  col-md-2 mb-0">
                                                            <input type="checkbox" id="input-13" checked="" >
                                                          </div>
                                                      </th>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <th rowspan="2"  >
                                                          <div class="  col-md-2  ">
                                                            <input type="text" value="10" id="" class="form-control" name="fname">
                                                          </div>
                                                        </th>
                                                        <th rowspan="2" >
                                                          <div class="  col-md-2  ">
                                                            <input type="text" value="2" id="" class="form-control" name="fname">
                                                          </div>
                                                        </th>
    ...
    <div class="modal fade text-xs-left" id="bootstrap" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <label class="modal-title text-text-bold-600" id="myModalLabel35"><b>Registro Sede / Filia / Local</b></label>
        </div>
        <form>
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12 mb-2">
                <label>Nombre (sede/filia/local)</label>
                <input type="text" class="form-control" name="fname">
            </div>
          </div>
          <div class="row">
