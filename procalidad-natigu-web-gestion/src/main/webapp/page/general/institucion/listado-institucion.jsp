				...
				<div class="content-header-left col-md-6 col-xs-12 mb-2">
					<div class="row breadcrumbs-top">
						<div class="breadcrumb-wrapper col-xs-12">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#" style="cursor: default;">General</a></li>
								<li class="breadcrumb-item active"><a href="#" style="cursor: default;">Instituci&oacute;n </a></li>
							</ol>
						</div>
					</div>
				</div>
											...
											<div class="form-body">
												<div class="row">
													<div class="form-group col-md-3 mb-2">
														<label for="projectinput1">Nombre de
															instituci&oacute;n</label>
														<f:input type="text" class="form-control"
															path="nombreInstitucion" maxlength="80" name="fname" pattern="[a-zA-Z ñÑáéíóúÁÉÍÓÚ]+" onKeyUp="this.value = this.value.toUpperCase();"/>
													</div>
													...
													<div class="form-group col-md-3 mb-2">
														...
														<fieldset class="form-group">
															...
															<f:select path="ubigeoBean.codigoRegion"
																class="form-control" id="codReg">
																<f:option value="00" label="Seleccionar" />
																<f:options items="${lstRegion}" itemValue="codigoRegion"
													...
													<div class="form-group col-md-3 mb-2">
														<fieldset class="form-group">
															<label for="tipoIdioma">Tipo de instituci&oacute;n</label>
															<f:select path="tipoInstitucion.codigoRegistro"
																class="form-control" id="codTipoInst">
																<f:option value="0" label="Seleccionar" />
																<f:options items="${lstTipo}" itemValue="codigoRegistro"
													...
													<div class="form-group col-md-3 mb-2">
														...
														<fieldset class="form-group">
															...
															<f:select path="situacion.codigoRegistro"
																class="form-control" id="codSit">
																<f:option value="0" label="Seleccionar" />
												...
												<div class="row">
													<div class="form-group col-md-12 text-right">
														<a
															href="${pageContext.request.contextPath}/institucionController/nuevo"
															class="btn btn-primary" title=""> <i
															class="icon-plus"></i> Nuevo
														</a>
														<button type="button" class="btn btn-secondary" onclick="limpiarInst();$('#tblInstitucion').dataTable().fnClearTable();">
												...
												<div class="row">
													<div class="col-xs-12" id="listadoDetalleIntitucion">
														<table id="tblInstitucion"
															class="table table-striped table-hover table-bordered zero-configuration">
															<thead>
																<tr>
																	<th  width="50">Nº</th>
															...
															<tbody>
																<c:forEach var="institucionBean"
																	items="${lstInstitucionBean}" varStatus="loop">
																	<tr>
																		<td>${loop.count}</td>
																		...
																		<td> 
																			<a title="Modificar" 
				                                                         	...
				                                                         	onclick="javascript:modificarElementoGenerico('/institucionController/modificar','${institucionBean.codigo}')"
				                                                         	><i class="icon-pencil"></i></a>
																			<!-- 
																			<a title="Modificar" data-placement="top"
																			data-toggle="tooltip"
																			class="btn btn-outline-success btn-sm"
																			href="modificar?codigo=${institucionBean.codigo}"><i
																			...
																			<button type="button"
																				...
																				onclick="confirmar_accion(${institucionBean.codigo})"
