...
<div class="tab-content px-1 pt-1">
	...
	<div class="tab-pane" id="tab42" aria-labelledby="base-tab42">
		...
		<div class="row">
         ...
         <div class="position-relative has-icon-left">
         <textarea id="textoTexto" rows="2" maxlength="400" class="form-control input-sm" name="notes"></textarea>
         <div class="form-control-position">
         <i class="ft-file"></i>
         </div>
         </div>
         ...
         <div class="position-relative has-icon-left">
         <textarea id="textoRelacionado" rows="2" maxlength="400" class="form-control input-sm" name="notes"></textarea>
         <div class="form-control-position">
         <i class="ft-file"></i>
         </div>
         </div>
