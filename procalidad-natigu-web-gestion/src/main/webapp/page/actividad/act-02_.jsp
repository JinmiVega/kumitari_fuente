...
<ul class="nav nav-tabs nav-linetriangle no-hover-bg">
	...
	<li class="nav-item"> 
		<a class="nav-link" onclick="mostrarTextoPalabraCorrectaxTEM();habilitarWYSIWYG('contentParrafo');$('.note-editor').addClass('form-control');" id="base-tab42" data-toggle="tab" aria-controls="tab43" href="#tab43" aria-expanded="false">Texto</a>
	</li>
	<li class="nav-item">
		<a class="nav-link"   onclick="listadoDePalabraCorrectaxTexto();" id="base-tab43" data-toggle="tab" aria-controls="tab42" href="#tab42" aria-expanded="false">Actividad</a>
	</li> 
	...
	<div  role="tabpanel" class="tab-pane " id="tab43" aria-expanded="true" aria-labelledby="base-tab43">
		<div class="form-body"> 
	        ...
	        <div class="form-group"> 
	            ...
	            <div class="position-relative ">
	              <input type="text" id="idoraciontitulo" class="form-control" maxlength="600" name="employeename" > 
	            </div>
	            <div class="position-relative ">
			      ...
			      <div class="" id="bodyParrafo">
					...
					<div class="form-group">
						...
						<div class="position-relative has-icon-left">
						  <textarea id="TxtComentario" rows="2" class="form-control input-sm" maxlength="5000" name="notes"> </textarea>
			  ...
			  <div class="form-group text-right mb-1">
			      ...
			      <button type="button" id="btn_guardar_ejercicio11" onclick="guardarTextoPalabraCorrecta();" class="btn btn-outline-info btn-min-width">
			       <i class="fa fa-floppy-o"></i> Guardar
			      </button>
			  </div>
	        </div> 
		...
		<div class="row">
	        ...
	        <div class="col-xs-6"> 
	       		...
	       		<div class="form-group col-md-9"> 
	            	...
	            	<input   type="text" id="txtnumeroespacio3" class="form-control" onkeypress="return valida(event)" maxlength="8" name="txtnumeroespacio3" onpaste="return false;"> 
	          	</div> 
	          
	          	<div class="form-group col-md-12"> 
	            <label id="espacio" for="timesheetinput1" style="margin-top:5px">Palabra incorrecta*</label>
	             <textarea rows="2" class="form-control input-sm" id="idespacio"  name="palabraclave" maxlength="100">
	              </textarea>
	          </div> 
	          ...
	          <tfoot>
				  ...
				  <button type="button" id="btn_nuevo" onclick="nuevoAlternativasPalabraCorrecta();" class="btn btn-outline-info btn-min-width" style="margin-top:20px">
					<i class="fa fa-file-o"></i>   Nuevo
				      ...
				      <button type="button" class="btn btn-outline-info btn-min-width" id="btn-guardar-oracionCd" onclick="agregarAlternativaPalabraCorrecta(1)" style="margin-top:20px">
				        <i class="fa fa-floppy-o"></i> Guardar
				      </button>
				  </div>
			  </tfoot>
	        ...
	        <div class="col-xs-6">
				<div class="table-responsive">
                    <table class="table table-bordered table-striped"> 
                        ...
                        <tbody id="idTablaEspaciosListado271"> 
                        </tbody>
                    </table>
                </div>
	      	</div>
