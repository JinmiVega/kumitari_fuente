...
<div class="tab-content px-1 pt-1">
	<div role="tabpanel" class="tab-pane active" id="tab41" aria-expanded="true" aria-labelledby="base-tab41">
		<div class="form-body">
	        ...
	        <div class="col-xs-7">
	         ...
	         <div class="form-group">
	            <label for="timesheetinput7">Oraci&oacute;n incorrecta </label>
	            <div class="position-relative has-icon-left">
	              <textarea id="timesheetinput7" rows="3" class="form-control" name="notes"></textarea>
	              <div class="form-control-position">
	                <i class="ft-file"></i>
	              </div>
	            </div>
	          	...
	          	<div class=" col-md-12">
	            <label for="timesheetinput1">Verbo </label>	            
	              </div>
	           
	          	
	              	<div class="form-group col-md-5">	   
	            <div class="position-relative ">
	              <textarea id="timesheetinput7" rows="1" class="form-control" name="notes"></textarea>
	              <div class="form-control-position">
	...
	<div class="tab-pane" id="tab42" aria-labelledby="base-tab42">
		<div class="row">
	        <div class="col-xs-6">
	          <div class="form-group">
	            <label for="timesheetinput7">Oraci&oacute;n correcta</label>
	            <div class="position-relative has-icon-left">
