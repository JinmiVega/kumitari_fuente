...
<!--
	...
	<li class="nav-item">
		<a class="nav-link active"  id="base-tab42" data-toggle="tab" aria-controls="tab42" href="#tab42" aria-expanded="false">Actividad</a>
	</li>
	<li class="nav-item">
	...
	<div role="tabpanel" class="tab-pane " id="tab41" aria-expanded="true" aria-labelledby="base-tab41">
		<div class="form-body">
	        ...
	        <div class="col-xs-7">
	          ...
	          <div class="form-group col-md-4 position-relative has-icon-left">
	...
	<div class="tab-pane active" id="tab42" aria-labelledby="base-tab42">
		<div class="row">
	        <div class="col-xs-6">
	           ...
	           <div class="form-group col-md-12">
	           <div class="form-group col-md-12">
	            <label for="timesheetinput1">Tiempo repetici&oacute;n</label>          
	          </div>
