...
<!-- 	<li class="nav-item">
	...
	<li class="nav-item">
		<a class="nav-link" id="base-tab45" data-toggle="tab" aria-controls="tab45" href="#tab45" aria-expanded="true">Actividad (Preguntas)</a>
	</li></li> -->
	<li class="nav-item">
...
<div class="tab-content px-1 pt-1">
	...
	<div role="tabpanel" class="tab-pane active" id="tab42" aria-expanded="true" aria-labelledby="base-tab42">
		<div class="row">
	        <div class="col-xs-6">
	          ...
	          <div class="form-group">
			    <label for="nombreUnidadLec">Sin&oacute;nimos</label>
				<div class="position-relative has-icon-left">
	...
	<div class="tab-pane" id="tab46" aria-labelledby="base-tab46">
	  ...
	  <div class="form-group">
			  ...
			  <span class="custom-control-indicator"></span>
			  <span class="custom-control-description">Habilitar traducci&oacute;n</span>
			</label>
	          </div>
	  ...
	  <div class="form-group">
				...
				<fieldset>
	          	  ...
	          	  <div class="form-group">
			    <label for="nombreUnidadLec">Acci&oacute;n</label>
				<fieldset>
					<div class="input-group input-group-xs">
						<span class="input-group-addon" id="radio-addon1">
							<label class="custom-control custom-radio inline">
