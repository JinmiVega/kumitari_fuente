<ul class="nav nav-tabs nav-linetriangle no-hover-bg">
	...
	<!-- <li class="nav-item">
		<a class="nav-link active" id="base-tab42" data-toggle="tab" aria-controls="tab42" href="#tab42" aria-expanded="true">Actividad (Emparejar)</a>
	</li> -->
<!-- 	<li class="nav-item">
	...
	<li class="nav-item">
		<a class="nav-link active" id="base-tab43" data-toggle="tab" aria-controls="tab43" href="#tab43" aria-expanded="true">Material</a>
	</li>
<!-- 	<li class="nav-item">
