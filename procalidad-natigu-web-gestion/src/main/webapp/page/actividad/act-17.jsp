<ul class="nav nav-tabs nav-linetriangle no-hover-bg">
	 <li class="nav-item">
		<a class="nav-link active" id="base-tab42" data-toggle="tab" aria-controls="tab42" href="#tab42" aria-expanded="true">Material</a>
	</li>
	...
	<div class="tab-pane active" id="tab42" aria-labelledby="base-tab42">
		<div class="row">
	        <div class="col-xs-6">	             
	            ...
	            <label for="timesheetinput7">Frase</label>
	          ...
	          <div class="form-group col-md-12">
			    <label for="nombreUnidadLec " style="margin-left:45px">Afiche</label>
			     </div>
			 ...
			 <div class="col-xs-5">
			  ...
			  <div class="form-group text-right col-xs-5 mb-3">
