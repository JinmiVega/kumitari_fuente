...
<div class="tab-content px-1 pt-1">
	        ...
	        <div class="col-xs-7">
	         ...
	         <div class="form-group">
	            ...
	            <div class="position-relative has-icon-left">
	              <textarea id="timesheetinput7" rows="4" class="form-control" name="notes"></textarea>
	...
	<div class="tab-pane" id="tab42" aria-labelledby="base-tab42">
		<div class="row">
	        <div class="col-xs-6">
	         <div class=" col-md-12">
	            <label for="timesheetinput1">Nombres </label>	            
	              </div>
	          ...
	          <!--   </div> -->
			 	...
			 	<div class=" col-md-12">
	            <label for="timesheetinput1">Verbos </label>	            
	              </div>
	          ...
	          <!--   </div> -->
			 	...
			 	<div class=" col-md-12">
	            <label for="timesheetinput1">Adjetivos </label>	            
	              </div>
	          ...
	          <!--   </div> -->
			 	...
			 	<div class=" col-md-12">
	            <label for="timesheetinput1">Adverbio </label>	            
	              </div>
